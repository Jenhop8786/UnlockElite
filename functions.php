...
function unlockElite_files() {
 ...
 wp_enqueue_style('unlockElite_main_styles', get_stylesheet_uri(), NULL, microtime());

}

add_action('wp_enqueue_scripts', 'unlockElite_files');

function unlockElite_features() {
